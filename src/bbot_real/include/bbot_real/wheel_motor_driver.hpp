...
namespace bbot_real
{
    ...
    public:
        ...
        /**
         * @brief 配置 TPDO0 主动上报 0x606C:03 左右实际速度
         *
         * 按 ZLAC8015D V4 CANopen 快速上手 6.1 节配置：
         * TPDO0 映射 0x606C:03，定时器触发，周期 20ms。
         * @return 配置是否成功
         */
        bool enable_speed_tpdo();

        /**
         * @brief 非阻塞读取 TPDO0 上报的左右实际速度
         * @return 是否收到了 TPDO0 速度帧
         */
        bool read_motor_speed_tpdo(double &out_left_rpm, double &out_right_rpm);
